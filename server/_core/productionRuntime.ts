...
export function productionResponseHeaders(req: Request) {
...
export function productionRuntimeMiddleware(req: Request, res: Response, next: NextFunction) {
...
export function publicServerError(requestId: string) {
